...
public class CustomerVO implements Serializable {
     ...
     * 最后跟进时间
     */
    @Excel(name = "最后跟进时间", orderNum = "6", width = 15 ,databaseFormat = "yyyyMMddHHmmss", format = "yyyy-MM-dd" )
    private Date latsTime;

    /**
     * 负责人名称
     */
    @Excel(name = "负责人名称", orderNum = "7", width = 15)
    private String userName;

    /**
     * 下次跟进时间
     */
    @Excel(name = "下次跟进时间", orderNum = "8", width = 15 ,databaseFormat = "yyyyMMddHHmmss", format = "yyyy-MM-dd" )
     ...
     * 录入时间
     */
    @Excel(name = "录入时间", orderNum = "11", width = 15 ,databaseFormat = "yyyyMMddHHmmss", format = "yyyy-MM-dd" )
