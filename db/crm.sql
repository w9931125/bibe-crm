...
-- 正在导出表  bibe_crm.area 的数据：~3,555 rows (大约)
DELETE FROM `area`;
...
CREATE TABLE IF NOT EXISTS `comment_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='跟进评论内容';
...
CREATE TABLE IF NOT EXISTS `customer` (
  ...
  `status` int(11) DEFAULT '0' COMMENT '删除状态1:已删除',
...
CREATE TABLE IF NOT EXISTS `customer_group` (
  ...
  `status` int(11) DEFAULT '0' COMMENT '自动转交状态:0未开启 1开启',
  `end_day` int(11) DEFAULT '0' COMMENT '转交天数--到期自动释放',
  `create_time` datetime DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='公客分组';
...
DROP TABLE IF EXISTS `customer_group_department_relation`;
CREATE TABLE IF NOT EXISTS `customer_group_department_relation` (
  `customer_group_id` int(11) DEFAULT NULL COMMENT '公客分组id',
...
CREATE TABLE IF NOT EXISTS `customer_progress` (
  ...
  `name` varchar(80) DEFAULT NULL COMMENT '联系人',
...
CREATE TABLE IF NOT EXISTS `department` (
  ...
  `parent_id` int(11) DEFAULT NULL COMMENT '父级id 0为顶级',
...
CREATE TABLE IF NOT EXISTS `permission` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '0菜单 1功能',
...
-- 正在导出表  bibe_crm.permission 的数据：~32 rows (大约)
DELETE FROM `permission`;
/*!40000 ALTER TABLE `permission` DISABLE KEYS */;
INSERT INTO `permission` (`id`, `name`, `path`, `status`, `type`, `parent_id`, `create_time`, `update_time`) VALUES
	(1, '职位与权限', NULL, 0, 0, 0, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(2, '部门与员工', NULL, 0, 0, 0, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(3, '客户资料', NULL, 0, 0, 0, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(4, '联系跟进', NULL, 0, 0, 0, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(6, '修改成员', '/user/update', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(7, '删除成员', '/user/delete', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(8, '添加职位', '/user/update', 0, 1, 1, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(9, '修改职位', '/user/update', 0, 1, 1, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(10, '删除职位', '/user/update', 0, 1, 1, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(11, '设置职位与权限', '/permission/add', 0, 1, 1, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(12, '新建部门', '/department/add', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(13, '删除部门', '/department/delete', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(14, '修改部门', '/department/update', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(15, '添加成员', '/user/add', 0, 1, 2, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(17, '可以修改负责人为自己的数据', '/customer/update', 0, 1, 3, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	...
	(30, '可以修改录入人为公客的联系跟进', '/customerProgress/updatePublic', 1, 1, 4, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	...
	(33, '可以删除录入人为公客的联系跟进', '/customerProgressdeletePublic', 1, 1, 4, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(34, '可以导出联系跟进资料', '/excel/exportProgress', 0, 1, 4, '2020-07-18 05:54:15', '2020-07-18 05:54:15'),
	(35, '允许设置公客分组', '/', 0, 1, 3, '2020-07-18 05:54:15', '2020-07-18 05:54:15');
...
CREATE TABLE IF NOT EXISTS `roles` (
  ...
  `number` int(11) DEFAULT '0' COMMENT '录入客户次数',
  `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '更新时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='职务角色';
...
DROP TABLE IF EXISTS `roles_customer_group_relation`;
CREATE TABLE IF NOT EXISTS `roles_customer_group_relation` (
  `role_id` int(11) DEFAULT NULL COMMENT '角色id',
  `customer_group_id` int(11) DEFAULT NULL COMMENT '公客分组id -1为全部客户 -2为用户所属部门'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='职务角色与公客分组关系表';

-- 正在导出表  bibe_crm.roles_customer_group_relation 的数据：~0 rows (大约)
DELETE FROM `roles_customer_group_relation`;
/*!40000 ALTER TABLE `roles_customer_group_relation` DISABLE KEYS */;
/*!40000 ALTER TABLE `roles_customer_group_relation` ENABLE KEYS */;

-- 导出  表 bibe_crm.roles_department_relation 结构
DROP TABLE IF EXISTS `roles_department_relation`;
CREATE TABLE IF NOT EXISTS `roles_department_relation` (
  `role_id` int(11) DEFAULT NULL COMMENT '角色id',
  `dept_id` int(11) NOT NULL COMMENT '部门id -1为全部客户 0为禁止 -2只看自己负责 -3同步客户 -4与自己同一个部门 -5与自己同一个部门及下级部门',
  `type` int(11) DEFAULT NULL COMMENT '0全部客户 1联系跟进'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='职务角色与部门权限关系表';
...
CREATE TABLE IF NOT EXISTS `roles_permission_relation` (
  ...
  `type` int(11) DEFAULT NULL COMMENT '1 客户资料 2联系跟进 3职位与权限 4部门与员工',
  `status` int(11) DEFAULT '0' COMMENT '状态 0启用 1禁止'
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `role_id` int(11) DEFAULT NULL COMMENT '角色id',
  `dept_id` int(11) DEFAULT NULL COMMENT '部门id',
  `host` varchar(30) DEFAULT NULL COMMENT '登录ip地址',
  `number` int(11) DEFAULT '0' COMMENT '录入客户剩余次数 -1无限制',
...
INSERT INTO `users` (`id`, `phone`, `password`, `name`, `role_id`, `dept_id`, `host`, `number`, `status`, `login_time`, `create_time`, `update_time`) VALUES
	(1, 'root', 'bc73dbfcdf2e5ef99e99407fc8ae8de3', 'admin', 1, 0, '172.17.0.1', -1, 0, '2020-08-31 20:09:51', '2020-07-18 06:23:18', '2020-07-18 06:23:18');
